                            ...
                            <div class="body-root-inner">
                                <div class="transection">
                                    <div class="title-right-actioin-btn-wrapper-product-list">
                                        <h3 class="title" style="margin-bottom: 0px;">Category Table</h3>
                                        <div class="button-wrapper">
                                            <a href="/admin/category/create" class="rts-btn btn-primary menu-btn">+
                                                Add</a>
                                        </div>
                                    </div>
                                    <div class="vendor-list-main-wrapper product-wrapper">
                                        <div class="card-body table-product-select">
                                            <div class="table-responsive">
                                                <table class="table table-hover table-category" id="example"
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="category" items="${categories}">
                                                            <tr>
                                                                <td>
                                                                    <p style="color: #2d3b29;">${category.id}</p>
                                                                </td>
                                                                <td>
