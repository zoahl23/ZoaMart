        ...
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <body>
                    ...
                    <div class="error-area-main-wrapper rts-section-gap2" style="padding-top: 0px;">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="error-main-wrapper">
                                        <div class="thumbnail">
                                            <img src="/images2/contact/${imageNotification}" alt="error"
                                                style="width: 20vw;">
                                        </div>
                                        <div class="content-main">
                                            <h2 class="title">${titleNotification}</h2>
                                            <p>${desNotification}</p>
                                        </div>
                                    </div>
                                </div>
