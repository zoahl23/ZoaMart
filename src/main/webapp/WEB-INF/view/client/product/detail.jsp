                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="profile-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="profile-tab-pane" aria-selected="false">Chi tiết
                                                    sản phẩm</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="profile-tabt" data-bs-toggle="tab"
                                                    data-bs-target="#profile-tab-panes" type="button" role="tab"
                                                    aria-controls="profile-tab-panes" aria-selected="false">Đánh giá
                                                    sản phẩm
                                                </button>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="tab-pane fade show active" id="profile-tab-pane" role="tabpanel"
                                                ...
                                                <div class="single-tab-content-shop-details">
                                                    ...
                                                    <p class="cansellation mt--20">
                                                        <span> Chính sách đổi/trả:</span> Sau khi đơn hàng đã được giao
                                                        thành công, chúng tôi không hỗ trợ thay đổi hoặc hủy đơn. Nếu
                                                        phát hiện sản phẩm có vấn đề về chất lượng hoặc số lượng, khách
                                                        hàng có thể yêu cầu đổi/trả ngay tại thời điểm nhận
                                                        hàng, với sự xác nhận của nhân viên giao hàng.
                                                    </p>
                                                    <p class="note">
                                                        <span>Lưu ý:</span> Thời gian giao hàng có thể thay đổi tùy theo
                                ...
                                <div class="title-area-between">
                                    ...
                                    <div class="next-prev-swiper-wrapper">
                                        <div class="swiper-button-prev" tabindex="0" role="button"
                                            aria-label="Previous slide" aria-controls="swiper-wrapper-6820acdb7c98fa1f">
                                            <i class="fa-regular fa-chevron-left"></i>
                                        </div>
                                        <div class="swiper-button-next" tabindex="0" role="button"
                                            aria-label="Next slide" aria-controls="swiper-wrapper-6820acdb7c98fa1f"><i
                                        ...
                                        <div class="swiper-wrapper" id="swiper-wrapper-6820acdb7c98fa1f"
                                            ...
                                            <div class="swiper-slide" data-swiper-slide-index="0"
                                                ...
                                                <div class="single-shopping-card-one">
                                                    ...
                                                    <div class="image-and-action-area-wrapper">
                                                        <a href="/product/${products[0].id}" class="thumbnail-preview">
                                                            <div class="badge">
                                                    ...
                                                    <div class="body-content">
                                                        ...
                                                        <span class="availability">${products[0].quantity} Pack</span>
                                            ...
                                            <div class="swiper-slide" data-swiper-slide-index="1"
                                                ...
                                                <div class="single-shopping-card-one">
                                                    <!-- iamge and sction area start -->
                                                    <div class="image-and-action-area-wrapper">
                                                        <a href="/product/${products[1].id}" class="thumbnail-preview">
                                                            <div class="badge">
                                                    ...
                                                    <div class="body-content">
                                                        ...
                                                        <span class="availability">${products[1].quantity} Pack</span>
                                                        <div class="price-area">
                                                            <span class="current">
                                                                <fmt:formatNumber
                                            ...
                                            <div class="swiper-slide" data-swiper-slide-index="2"
                                                ...
                                                <div class="single-shopping-card-one">
                                                    <!-- iamge and sction area start -->
                                                    <div class="image-and-action-area-wrapper">
                                                        <a href="/product/${products[2].id}" class="thumbnail-preview">
                                                            <div class="badge">
                                                    ...
                                                    <div class="body-content">
                                                        ...
                                                        <span class="availability">${products[2].quantity} Pack</span>
                                                        <div class="price-area">
                                                            <span class="current">
                                                                <fmt:formatNumber
                                            ...
                                            <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="3"
                                                ...
                                                <div class="single-shopping-card-one">
                                                    <!-- iamge and sction area start -->
                                                    <div class="image-and-action-area-wrapper">
                                                        <a href="/product/${products[3].id}" class="thumbnail-preview">
                                                            <div class="badge">
                                                    ...
                                                    <div class="body-content">
                                                        ...
                                                        <span class="availability">${products[3].quantity} Pack</span>
                                                        <div class="price-area">
                                                            <span class="current">
                                                                <fmt:formatNumber
                                            ...
                                            <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="4"
                                                ...
                                                <div class="single-shopping-card-one">
                                                    <!-- iamge and sction area start -->
                                                    <div class="image-and-action-area-wrapper">
                                                        <a href="/product/${products[4].id}" class="thumbnail-preview">
                                                            <div class="badge">
                                                    ...
                                                    <div class="body-content">
                                                        ...
                                                        <span class="availability">${products[4].quantity} Pack</span>
                                                        <div class="price-area">
                                                            <span class="current">
                                                                <fmt:formatNumber
                                            ...
                                            <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="5"
                                                ...
                                                <div class="single-shopping-card-one">
                                                    <!-- iamge and sction area start -->
                                                    <div class="image-and-action-area-wrapper">
                                                        <a href="/product/${products[5].id}" class="thumbnail-preview">
                                                            <div class="badge">
                                                    ...
                                                    <div class="body-content">
                                                        ...
                                                        <span class="availability">${products[5].quantity} Pack</span>
                                                        <div class="price-area">
                                                            <span class="current">
                                                                <fmt:formatNumber
                                            ...
                                            <div class="swiper-slide" data-swiper-slide-index="6"
                                                ...
                                                <div class="single-shopping-card-one">
                                                    <!-- iamge and sction area start -->
                                                    <div class="image-and-action-area-wrapper">
                                                        <a href="/product/${products[6].id}" class="thumbnail-preview">
                                                            <div class="badge">
                                                    ...
                                                    <div class="body-content">
                                                        ...
                                                        <span class="availability">${products[6].quantity} Pack</span>
                                                        <div class="price-area">
                                                            <span class="current">
                                                                <fmt:formatNumber
