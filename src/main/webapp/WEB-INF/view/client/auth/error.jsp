                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="error-main-wrapper">
                                        <div class="thumbnail">
                                            <img src="/images2/contact/01.png" alt="error" style="height: 40vh;">
                                        </div>
                                        <div class="content-main">
                                            <h2 class="title">Trang này không tồn tại</h2>
                                            <p>Xin lỗi, chúng tôi không thể tìm thấy trang mà bạn đang tìm kiếm. Vui
                                                lòng quay lại trang chủ.</p>
