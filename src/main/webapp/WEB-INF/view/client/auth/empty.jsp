                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="error-main-wrapper">
                                        <div class="thumbnail">
                                            <img src="/images2/contact/03.png" alt="error" style="height: 40vh;">
                                        </div>
                                        <div class="content-main">
                                            <h2 class="title">Sản phẩm không đủ hàng</h2>
                                            <p>Rất tiếc, số lượng sản phẩm bạn đã chọn hiện không còn đủ trong kho. <br>
                                                Vui lòng điều chỉnh lại số lượng hoặc chọn sản phẩm khác.</p>
